---
title: "How to draw the Economist-style graph with ggplot2 in R?"
tags: [r]
categories: [r]
author_profile: true
layout: single
...
In this tutorial, we are going to create an Economist-style graph in R by using ```ggplot2```, ```ggthemes```, ```showtext```, ```ggtext```and ```grid``` packages. I am going to use a dataset that I have been collecting since 2014 about the poverty line and minimum wage in Turkey, but you can adopt these codes to any dataset you want to visualize. 
